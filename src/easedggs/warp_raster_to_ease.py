'''
Warping raster to EASE-DGGS functions.
...
'''
from easedggs.constants import grid_spec, levels_specs, ease_crs
from easedggs.grid_align import easedggs_grid_bounds
from easedggs.dggs.checks import check_level
import rasterio
...
def generate_raster_geoproperties (dataset, level, globalextent):
    ...
    # define pixel resolution from easedggs spec
    ...
    if globalextent == True:
        ...
        min_x, min_y, max_x, max_y = easedggs_grid_bounds((min_x_src, min_y_src, max_x_src, max_y_src),
...
def warp_raster_to_ease(inrasterpath, outrasterpath, level, globalextent, resamplingmethod, nodata=None,
