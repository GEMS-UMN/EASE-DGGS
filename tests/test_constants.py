'''
Unit tests for EASE-DGGS constants.py module.
...
def _define_grid_levels_specs():
    '''Calculate and define the specifications for the EASE-DGGS.
    ...
    -------
    grid_spec : dictonary
        Dictonary containing EASE-DGGS parameters/specifications.
    levels_specs : dictonary
        Dictonary containing level specification for EASE-DGGS
    ease_crs : int
        EPSG Code value for EASE v2
    geo_crs : int
        EPSG Code value for geographic coordinates
    cell_scale_factors : np.array
        Scaling factors used internally by EASE-DGGS library
    mult_fact : list
