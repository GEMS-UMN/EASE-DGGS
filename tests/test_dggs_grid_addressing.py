'''
Test for EASE-DGGS DGGS Indexing functions.
...
class Test_GridXYToGridId(TestDict,ValidGems):
    def test__grid_xy_to_grid_id_type(self):
        ...
        results = [_grid_xy_to_grid_id(t) for t in self._valid_easedggs]
    ...
    def test__grid_xy_to_grid_id_incorrect(self):
        test = [Point(pt[0], pt[1]) for pt in self._valid_easedggs]
