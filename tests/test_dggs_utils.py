'''
PyTest functions for EASE-DGGS DGGS utils functions.
...
class TestShiftRange:
    ...
    # when shifted from ease to EASE-DGGS_xy coords, the shifted coords are good to 6 decimal places
    ...
    # when shifted from EASE-DGGS_xy coords, the resulting ease coords are good to 5 decimal places
